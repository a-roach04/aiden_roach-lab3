...
> There are 30,463 rows and 15 columns in this dataset.
...
> There are integers, dates, and strings
...
#Final scatterplot of weight and hindfoot length by species
ggplot(data = surveys,
  ...
  labs(x = "Weight of Animal (g)",
       y = "",
         title = "Relationship of an Animal's Weight and Their Hindfoot Length Split by Species",
...
#Final boxplot of species and weight
ggplot(data = surveys,
       mapping = aes(x = weight,
                     y = species)) +
  geom_boxplot(outlier.shape = NA) + 
  labs(x = "Weight of Rodent (g)",
       y = "Species of Rodent",
       title = "Relationship of a Rodent's Weight and Their Species") + 
  theme(axis.text.x = element_text(angle = 45)) + 
  theme(axis.text.y = element_text(angle = 45)) + 
  geom_jitter(colour = "orchid",
              alpha = 0.1)
```
...
#Same boxplot as before but rotated
ggplot(data = surveys,
       mapping = aes(x = weight,
                     y = species)) +
  geom_boxplot(outlier.shape = NA) + 
...
# Challenge!! Exploring ggplot2 Annotation
...
#Example provided by bestie Judith
ggplot(data = surveys, 
...
```{r}
#| label: Challenge boxplot

bp_color <- c("#89BD9E", "#011936", "#F79D65", "#355070", "#254D32", "#B4ADEA", "#CC79A7", "#861657")
...
ggplot(data = surveys,
  ...
  labs(x = "Weight of Rodent (g)",
       y = "",
       title = "Relationship of a Rodent's Weight and Their Genus and Species") + 
  annotate("text", y = 1, x = 250, label = "Onychomys") + 
  annotate("text", y = 2, x = 250, label = "Dipodomys") + 
  annotate("text", y = 3, x = 250, label = "Chaetodipus") + 
  annotate("text", y = 4, x = 250, label = "Dipodomys") + 
  annotate("text", y = 5, x = 250, label = "Dipodomys") + 
  annotate("text", y = 6, x = 250, label = "Reithrodontomys") + 
  annotate("text", y = 7, x = 250, label = "Peromyscus") + 
  annotate("text", y = 8, x = 250, label = "Onychomys") + 
  annotate("text", y = 9, x = 250, label = "Sigmodon") + 
  annotate("text", y = 10, x = 250, label = "Reithrodontomys") + 
  annotate("text", y = 11, x = 250, label = "Perognathus") + 
  annotate("text", y = 12, x = 250, label = "Peromyscus") + 
  annotate("text", y = 13, x = 250, label = "Chaetodipus") + 
  annotate("text", y = 14, x = 250, label = "Neotoma")
```
